...
De fleste innstillingene kan endres i fanen «Configuration» i Conquest Windows-appen. Ytterligere innstillinger finner du i filen c:\dicomserver\dicom.ini, men disse vil tilbakestilles til standard hver gang analyserom startes.
