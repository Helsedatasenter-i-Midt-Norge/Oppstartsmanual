...
Hvis du selv skal laste ned filen(e) i analyserom, hak av for "Get a link instead of sending to recipients" og trykk på Send. Hvis du skal sende til en annen mottaker fører du opp riktig e-postadresse i angitt felt. Nedlastingslenken/Download link må deretter kopieres i sin helhet `"https://filesender.sikt.no...` Inne i analyserom åpner du nettleser og limer inn nedlastingslenken for nedlastning.
...
Filene lastes ned som standard til Downloads-mappa i analyserom, slik som på en vanlig PC. Filene må overføres til prosjektmappa. Filer i Downloads blir slettet når du logger av analyserommet. 
